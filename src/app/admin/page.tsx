      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-10 sm:px-8">
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          <PortalCard
            ...
            description="Track architectural scans, blueprints, design scopes, and cohort restoration milestones."
          ...
          <PortalCard
            eyebrow="Operations Track"
            title="Legal Track"
            description="Track 501(c)(3) filings, trademarks, foreign entity, and state solicitation compliance."
            href="/admin/law"
            cta="Open Legal Portal"
          />
          <PortalCard
            eyebrow="Operations Track"
            title="Grants & Deadlines"
            description="Track upcoming grant proposal writing tasks, funding thresholds, and active submission timelines."
            href="/admin/grants"
