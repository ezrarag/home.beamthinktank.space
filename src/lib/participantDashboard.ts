...
const ORGANIZATION_CATALOG: ParticipantArea[] = [
  ...
  },
  {
    ...
    name: "BEAM Hood",
    shortName: "Hood",
    description: "Neighbor Hood: village-fund support and family/friend backing for participants across every division.",
    href: "https://hood.beamthinktank.space",
    kind: "organization",
    tags: ["community", "village-fund", "support"],
    source: "catalog",
  },
  {
    id: "org_beam_grounds",
    name: "BEAM Grounds",
    shortName: "Grounds",
    description: "Real estate, civic infrastructure, and neighborhood development inside the BEAM network.",
    href: "https://grounds.beamthinktank.space",
    kind: "organization",
    tags: ["real-estate", "civic", "redevelopment"],
    source: "catalog",
  },
  {
    id: "org_beam_forge",
    ...
    kind: "organization",
    tags: ["software", "hardware", "civic-tech"],
    source: "catalog",
  },
  {
    id: "org_beam_law",
    ...
    kind: "organization",
    tags: ["legal", "pro-bono", "civic-rights"],
    source: "catalog",
  },
  {
    id: "org_beam_dance",
    ...
    href: "https://dance.beamthinktank.space",
    kind: "organization",
    tags: ["dance", "performance", "residency"],
    source: "catalog",
  },
  {
    id: "org_beam_education",
    name: "BEAM Education",
    shortName: "Education",
  ...
  {
    id: "org_beam_transportation",
    name: "BEAM Transportation",
    ...
    kind: "organization",
    tags: ["transit", "mobility", "repair-cohort"],
    source: "catalog",
  },
  {
    id: "org_beam_business",
    name: "BEAM Business",
    shortName: "Business",
    description: "Micro-enterprise development and local business accelerators.",
    href: "https://business.beamthinktank.space",
    kind: "organization",
    tags: ["micro-enterprise", "accelerator", "local-business"],
    source: "catalog",
  },
];
