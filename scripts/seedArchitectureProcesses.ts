...
const beamProcesses: BeamProcess[] = [
  {
    title: "Central UMC — Roof Restoration & Brick-and-Mortar Grant",
    domain: "architecture",
    stages: [
      {
        id: "documented",
        ...
        status: "complete",
        owner: "Ezra",
        note: "Initial structural assessments and documentation completed.",
        updatedAt: now,
      },
      {
        id: "design-scoped",
        ...
        status: "active",
        owner: "Ezra",
        note: "Finalizing restoration blueprints and brick-and-mortar budget.",
        updatedAt: now,
      },
      {
        id: "cohort-assigned",
  ...
  {
    title: "Zao MKE — Architectural Documentation",
    domain: "architecture",
    stages: [
      {
        id: "documented",
  ...
  {
    title: "MPM / 800 W. Wells — RFP Response Prep",
    domain: "architecture",
    stages: [
      {
        id: "documented",
